...
const AddCategory = ({ display, onAdd }) => {
    ...
    function addCategory() {
        if (category === "") {
            ...
            axios.post(producttype, {
                ...
                onAdd(newCategory); // ուղարկել parent-ին
                setCategory("");
                setError("");
                setImages([]);
                display(false);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="relative bg-white rounded-lg shadow-2xl p-6 w-11/12 md:w-1/2 lg:w-1/3 max-w-lg max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button className="text-gray-500 hover:text-gray-800" onClick={() => display(false)}>
                        ...
                        <div className="w-full">
                            ...
                            >
                                {imageList.length === 0 ? (
                                    ...
                                    <div className="relative flex items-center justify-center p-2 rounded-md w-full h-full">
                                        <img
                                        ...
                                        <button
                                            type="button"
                                            onClick={(e) => { e.stopPropagation(); onImageRemove(0); }}
